        ...
        if time > 0:
            ...
            for index in range(len(comparison_str)):
                if comparison_str[index] > 0:
                    comparison_str[index] = '+' +  str(int(comparison_str[index]))
            ...
            for month in range(0,12,TIME_STEP):
                ...
                if year < PAYBACK_PERIOD:
                    ...
                    if withRule:
                        ...
                        print('The action rule recommends is {}'.format(recomend))
                    print('Now your company own {} ships'.format(str(ship.exist_number+ship.order_number)))
